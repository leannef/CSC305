...
hitable *simple_light(){
    texture *pertext = new noise_texture(6);
    hitable **list = new hitable*[4];
    int nx,ny,nn;
    unsigned char *tex_data = stbi_load("/Volumes/leannef/csc305/csc305a1/Red.png",&nx,&ny,&nn,0);
    material *emat = new lambertian(new image_texture(tex_data,nx,ny));
    list[0] = new sphere(vec3(0,-1000,0),1000,new lambertian(pertext));
    //list[1] = new sphere(vec3(0,2,0),2,new lambertian(pertext));
    list[1] = new sphere(vec3(0,2,0),2,emat);
...
hitable *two_perlin_spheres(){
    texture *pertext = new noise_texture(7);
    hitable **list = new hitable*[2];
    int nx,ny,nn;
    unsigned char *tex_data = stbi_load("/Volumes/leannef/csc305/csc305a1/Red.png",&nx,&ny,&nn,0);
    material *emat = new lambertian(new image_texture(tex_data,nx,ny));
    list[0] = new sphere(vec3(0,-1000,0),1000,emat);
    list[1] = new sphere(vec3(0,2,0),2,new lambertian(pertext));
...
hitable *final(){
    ...
    for (int i= 0;i < nb; i++) {
     ...
     material *light = new diffuse_light( new constant_texture(vec3(3.3 , 3.5 , 3.8)) );
     list[l++] = new xz_rect(123, 423, 147, 412, 554, light);
     list[l++] = new xz_rect(-555, 1110, -555, 1110, 0, ground);
